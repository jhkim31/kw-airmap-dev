                ...
                for (var j = 0; j < canvas.width / pixelGap; j++) {
                    ...
                    switch (overlay_type) {
                        ...
                        case 1:         //pm25
                            ...
                            break;
                        case 2:         //t
                            value = (parseFloat(value) + 20) * 1.538461538          //스펙트럼 보 ~ 파 ~ 초 ~ 빨 ~ 검
                            break;
                        case 3:
                            value = (100 - value) * 0.8
                            break
                    ...
                    if (overlay_type != 2) {
                        ...
                        if (value < 16.667){        // -20 ~ -10
                            value = value * 9;
                            r = 150 - value;
                            g = 0;
                            b = 250;
                            ctx.fillStyle = `rgb(${r}, ${g}, ${b})`
                        } else if (value < 33.334) {    //-10 ~ 0
                            value = (value - 16.667) * 15
                            r = 0;
                            g = value;
                            b = 250;
                            ctx.fillStyle = `rgb(${r}, ${g}, ${b})`
                        } else if (value < 50) {        //0 ~ 10
                            value = (value - 33.334) * 15
                            r = 0;
                            g = 250;
                            b = 250 - value
                            ctx.fillStyle = `rgb(${r}, ${g}, ${b})`
                        } else if (value < 66.667) {    //10 ~ 20
                            value = (value - 50) * 15
                            r = value
                            g = 250;
                            b = 0
                            ctx.fillStyle = `rgb(${r}, ${g}, ${b})`
                        } else if (value < 83.335) {    //20 ~ 30
                            value = (value - 66.667) * 15
                            r = 250;
                            g = 250 - value
                            b = 0;
                            ctx.fillStyle = `rgb(${r}, ${g}, ${b})`
                        } else if (value < 100){        //30 ~ 40
